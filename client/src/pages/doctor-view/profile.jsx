...
import { Mail, Phone, MapPin, Briefcase, Edit2, Save, X, Lock, Camera, Award, Calendar, Users, Upload, Loader2 } from 'lucide-react';
...
export default function DoctorProfile() {
  ...
  return (
    <div className="space-y-6">
      {/* Profile Header */}
      <div className="bg-gradient-secondary rounded-lg p-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-white/80">{displayValue(formData.specialization)}</p>
            </div>
          </div>
          ...
          <Card className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-700 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {isEditing ? (
                  <Input name="specialization" value={formData.specialization} onChange={handleInputChange} className="mt-2" />
                ) : (
                  <p className="mt-2 text-gray-900 dark:text-gray-100 font-medium">{displayValue(formData.specialization)}</p>
                )}
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  <Input name="licenseNumber" value={formData.licenseNumber} onChange={handleInputChange} className="mt-2" />
                ) : (
                  <p className="mt-2 text-gray-900 dark:text-gray-100 font-medium">{displayValue(formData.licenseNumber)}</p>
                )}
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  <Input name="experience" type="number" value={formData.experience} onChange={handleInputChange} className="mt-2" />
                ) : (
                  <p className="mt-2 text-gray-900 dark:text-gray-100 font-medium">
              ...
              <div className="md:col-span-2">
                <Label className="text-gray-700 dark:text-gray-300 flex items-center gap-2">
                  <MapPin className="w-4 h-4" /> Clinic/Hospital
                </Label>
                {isEditing ? (
                  <Input name="clinic" value={formData.clinic} onChange={handleInputChange} className="mt-2" />
                ) : (
                  <p className="mt-2 text-gray-900 dark:text-gray-100 font-medium">{displayValue(formData.clinic)}</p>
                )}
              </div>
          ...
          <Card className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-700 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center pb-3 border-b border-gray-200 dark:border-slate-700">
                ...
                <span className="font-bold text-gray-900 dark:text-gray-100">{formData.experience ? `${formData.experience} yrs` : 'Not set'}</span>
              </div>
